            ...
            <div class="bg-white shadow rounded p-6">
                ...
                <form method="POST" action="{{ route('metas.update', $meta->id) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input name="codigo" value="{{ old('codigo', $meta->codigo) }}"
                               class="w-full border rounded px-3 py-2">
                    </div>

                    <div class="mb-4">
                        <label class="block mb-1">Nombre</label>
                        <input name="nombre" value="{{ old('nombre', $meta->nombre) }}"
                               class="w-full border rounded px-3 py-2">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" rows="3"
                                  class="w-full border rounded px-3 py-2">{{ old('descripcion', $meta->descripcion) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center gap-2">
                            <input type="checkbox" name="activo" value="1"
                                   {{ old('activo', $meta->activo) ? 'checked' : '' }}>
                            <span>Activo</span>
                        </label>
                    </div>
